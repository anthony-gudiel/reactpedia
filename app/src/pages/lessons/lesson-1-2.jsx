      ...
      <div className="lesson-content">
        ...
        <div className="container-2">
          ...
          <div className="jsx-paragraph">
            <strong>Definition: </strong> JSX stands for JavaScript XML. It's a
            syntax extension for JavaScript recommended by React or describing
            ...
            <ul>
              <li>
                JSX allows you to include expressions and functions within the
                syntax
              </li>
          ...
          <div className="jsx-syntax-paragraph">
            <strong>Embedding expressions: </strong> In JSX, you can embed
            JavaScript expressions within curly braces '&#123;...&#125;' like
            this:
            <div className="break"></div>
            <div className="code">
              const name = "John";
            ...
            <strong>HTML-like Elements: </strong> JSX allows you to write
            ...
            <ul>
              <li>
                Components are arguably the most important part of React, and
                can be considered the building blocks of React applications
              </li>
            ...
            <ul>
              <li>
                Properties (in this case 'props') can be used to pass data to
                components. Properties pass information from a parent component
                to a child component
              </li>
              <li>
                {" "}
                '&#123;props.name&#125;' is an example of how you can access a
                specific property named 'name'. This assumes that the parent
                component is passing a property called 'name' like this:
              </li>
            </ul>
            <div className="code">
              // Parent Component
            ...
            In this example, the App component is rendering the 'Greeting'
            component and passing the 'name' prop with the value 'John'. The
            'Greeting' component receives this prop through the 'props' object
            and uses it in the JSX expression to dynamically display a
            personalized greeting. The resulting output would be
            &#60;p&#62;Hello, John! &#60;/p&#62;
            <div className="break"></div>
            <strong>Conditional Rendering: </strong> JSX allows you to use
            JavaScript for conditional rendering, which is the process of
            displaying different content based on certain conditions or states
            <div className="code">
            ...
            Here we can see that if the user is logged in, the message 'Welcome
            back!' would be returned, but if not, 'Please log in.' would be
            returned.
            ...
            <ul>
              <li>
                It's good practice to wrap JSX elements in parentheses when they
            ...
            <div className="parent-explanation">
              Do you see the difference? In this first valid example, there is a
              single &#60;div&#62; that contains all elements, where in the
              second example, there is no parent element (&#60;div&#62;)
            </div>
            <a className="lesson-1-button" href="./lesson-1-1">
              Previous Lesson
            </a>
