    ...
    <div className='lesson-1-1'>
      ...
      <div className='container-2'>
        ...
        <div className='overview-paragraph'>
          <ul>
            <li>In React, a component is a reusable, self-contained building block that encapsulates a piece of the user interface.</li>
        ...
        <div className='what-is-paragraph'>
          <ul>
            <li>These kinds of components are declared as JavaScript functions.</li>
            <li>Typically simple and concise, especially for presentational components.</li>
          </ul>
          <div className='code'>
          ...
          <ul>
            <li>This code represents a basic React component (MyApp) that you can use as the starting point for your application. When you import MyApp into another file, you can include and render it as a component in your application.</li>
         </ul>
        </div>
        <div className='first-app'>
          <h3> Importing and Exporting: </h3>
            <ul>
              <li>In the previous example, the export default statement is used to export the MyApp component as the default export from this module.</li>
              <li>This allows you to import and use MyApp in other parts of your application.</li>
          ...
          <ul>
            <li>It is best practice to put these import statements in the first lines of your file</li>
            <li>In this example, we're importing our 'MyApp' component from the 'MyApp.jsx' file into another file, though we don't explicitly state the .jsx extension in the import statement</li>
          </ul>
          <h3>Summary: </h3>
          <div className='break'></div>
      ...
      />
      <button className='ai-submit' onClick={() =>handleAIResponse(userInput)}>Click to Submit!</button>
